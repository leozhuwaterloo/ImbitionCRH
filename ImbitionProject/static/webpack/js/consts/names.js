...
NAMES.FILTER_PROFILE_VIEW = '日志档案';
NAMES.COLUMN_HIDDEN = '隐藏项';
NAMES.FILTER_PROFILE_LOAD = '加载';
NAMES.SAVE_FILTER_PROFILE = '保存档案';
NAMES.NO_FILTER_PROFILE_TO_SAVE = '没有可以保存的档案';
NAMES.FILTER_PROFILE_NAME = '档案名';
NAMES.FILTER_PROFILE_FILTER_OBJ = '过滤镜';
NAMES.FILTER_PROFILE_SHOW_COMMENT = '显示备注';
NAMES.FILTER_PROFILE_COLUMN_HIDDEN = '隐藏项';
NAMES.FILTER_PROFILE_SEARCH_TEXT = '搜索项';
NAMES.FILTER_PROFILE_DELETE = '删除档案';
