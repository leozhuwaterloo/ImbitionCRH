...
const mapStateToProps = (state) => {
  ...
  mapDispatchToProps = dispatch => ({
    ...
    fetchEmployee: employeeId => dispatch(fetchData(`employee/${employeeId}`, 'employee')),
    ...
    updateEmployee: (employeeId, body) => {
      dispatch(updateData(`employee/${employeeId}`, body, employeeId, () => {
        dispatch(fetchData(`employee/${employeeId}`, 'employee'));
      }));
    },
  }),
